...
public class ParticleDataConstant
{
	...
	//起始颜色
	public static final float[][] START_COLOR={{0.145f,0.242f,0.93f,0.1f},{0.5f,0.5f,0.5f,0.1f}};
//			{
...
//			};
	...
	//终止颜色
	public static final float[] END_COLOR={0.43f,0.62f,0.9f,0.0f};	//0-普通火焰
//			{
...
//			};
	...
	//源混合因子
	public static final int[] SRC_BLEND={GLES30.GL_SRC_ALPHA,GLES30.GL_SRC_ALPHA};			//0-普通火焰
//			{
...
//			};
	...
	//目标混合因子
	public static final int[] DST_BLEND={GLES30.GL_ONE,GLES30.GL_ONE};//GLES30.GL_ONE;//0-普通火焰
//			{
...
//			};
	...
	//混合方式
	public static final int[] BLEND_FUNC={GLES30.GL_FUNC_ADD,GLES30.GL_FUNC_ADD};
//			{
...
//			};
	...
	//
	public static final int[] COUNT={50,10};
	//			{
//					340,   				//0-普通火焰
//					340,   					//1-白亮火焰
//					99,				//2-普通烟
...
//			};
	//单个粒子半径
	public static final float[] RADIS={450f,100f};
//			{
//					60*0.5f,		//0-普通火焰
//					60*0.5f,		//1-白亮火焰
//					60*0.8f,		//2-普通烟
...
//			};
	...
	//粒子最大生命期
	public static final float[] MAX_LIFE_SPAN={3.0f,4.0f};
//			{
//					5.0f,		//0-普通火焰
//					5.0f,		//1-白亮火焰
//					6.0f,		//2-普通烟
...
//			};
	...
	//粒子生命周期步进
	public static final float[] LIFE_SPAN_STEP={0.06f,0.05f};
//			{
//					0.07f,		//0-普通火焰
//					0.07f,		//1-白亮火焰
//					0.07f,		//2-普通烟
...
//			};
	...
	//粒子发射的X左右范围
	public static final float[] X_RANGE={13.0f,5.0f};
//			{
//					0.5f,		//0-普通火焰
//					0.5f,		//1-白亮火焰
//					0.5f,		//2-普通烟
...
//			};
	...
	//粒子发射的Y上下范围
	public static final float[] Y_RANGE={5f,10f};
//			{
//					0.3f,		//0-普通火焰
//					0.3f,		//1-白亮火焰
//					0.15f,		//2-普通烟
...
//			};
	...
	//粒子发射的Z上下范围
	public static final float Z_RANGE=13f;

	//每次喷发发射的数量
	public static final int[] GROUP_COUNT={1,1};
//			{
//					4,			//0-普通火焰
//					4,			//1-白亮火焰
//					1,			//2-普通烟
...
//			};
	...
	//粒子Y方向升腾的速度
	public static final float[] VY={0.03f,0.03f};
//			{
//					0.05f,		//0-普通火焰
//					0.05f,		//1-白亮火焰
//					0.04f,		//2-普通烟
