...
import static com.bn.Constant.Constant.cy;
import static com.bn.Constant.Constant.cz;
import static com.bn.Particle.ParticleDataConstant.lock;
import static com.bn.Util.ShaderUtil.createProgram;

/**
 * Created by Administrator on 2017/12/21.
 */

public class ParticleFireworkForDraw {
    ...
    public ParticleFireworkForDraw(MyGLSurFaceView mv, float halfSize)
    {
    ...
    {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("vertex_particle.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader= ShaderUtil.loadFromAssetsFile("frag_particle.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
    ...
    public void drawSelf(int texId,float[] startColor,float[] endColor,float maxLifeSpan)
    {
        ...
        //将摄像机位置传入渲染管线
        GLES30.glUniform3f(muCameraPosition, MatrixState3D.cameraPosition[0], cy, cz);
        //将基本变换矩阵总矩阵传入渲染管线
