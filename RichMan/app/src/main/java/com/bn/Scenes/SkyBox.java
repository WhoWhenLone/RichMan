...
public class SkyBox
{
    ...
    {
        String mVertexHandle= ShaderUtil.loadFromAssetsFile("vertex_tex.sh", mv.getResources());
        String mTexCoorHandle= ShaderUtil.loadFromAssetsFile("frag_tex.sh", mv.getResources());
    ...
    public void drawSelf(int texId)
    {
        ...
        MatrixState3D.translate(2*Mapscale,2*Mapscale,-2*Mapscale);
        MatrixState3D.rotate(0,0,1,0);
        MatrixState3D.scale(2.5f,2.5f,2.5f);
        //将最终变换矩阵送入渲染管线
